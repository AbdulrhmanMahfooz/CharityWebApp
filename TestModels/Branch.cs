...
{
    [Index(nameof(CityNo), Name = "FK_Branches_Cities")]
    [Index(nameof(CountryNo), Name = "FK_Branches_Countries")]
    [Index(nameof(DistrictNo), Name = "FK_Branches_Districts")]
    [Index(nameof(RegionNo), Name = "FK_Branches_Regions")]
    public partial class Branch
    {
        ...
        [Column("Date_Open", TypeName = "datetime(6)")]
